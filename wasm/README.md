...
- `../public/tml-wasm-loader.js` — WASM loader, worker caching, seed triangle reuse, and result serialization.
- `../src/wasm/vietoris-rips-wasm.ts` — point projection helper that calls `tml_project_points` from WASM.
...
The browser worker is implemented in `public/tml-wasm-loader.js`.
...
Inside `public/tml-wasm-loader.js`:
...
- `TML_Demo/wasm/tml_filtration.cpp`
  - `tml_project_points(...)`
...
- `TML_Demo/public/tml-wasm-loader.js`
